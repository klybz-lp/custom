...
function createLi(){
	for (var i = 0; i < 101; i++) {
		...
		li.innerHTML = '<a data-link="http//:www.baidu.com"><img src="iphone.jpg" alt=""> <span class="spanWrap"><span class="sTitle">苹果(Apple)iphone'+i+'(A1586) 32G金色移动 联通电信4G手机</span> <span class="sPrice">¥4888.00</span> <span class="sComment">好评96% 59091</span></span></a>';
		inner.append(li);
		var a = li.children[0];
		tap(a,function(){
			//alert(this.getAttribute("dataLink"));
...
function tap(el,fn){
	...
	el.addEventListener('touchend', function(e) {
		...
		if(dis.x < 5 && dis.y < 5){  //如果没有发生toucemove或移动的距离很小都是点击事件，反之则是toucemove事件
			fn.call(el,e);
		}
	});
}