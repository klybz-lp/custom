<?php
	...
	*/
	...
	class Model
	{
		protected $host = DB_HOST;  //主机名
		protected $user = DB_USER;  //用户名
		protected $pwd = DB_PWD;  //密码
		protected $dbname = DB_NAME;  //数据库名
		protected $charset = DB_CHARSET;  //字符集
		protected $prefix = DB_PERFIX;  //表前缀
		...
		private function getTableName()
		{
			...
			$className = get_class($this);  //得到当前类名字符串,如model\AdminModel 
			$table = strtolower(substr(substr($className, 0, -5), 6));  //去掉字符串后面的Model得到表名
